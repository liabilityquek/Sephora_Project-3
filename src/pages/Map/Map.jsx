  ...
  return (
    <div>
      ...
      >
          ...
          >
            <Popup>
              <div>
                ...
                <br />
                <Link
                  to={`https://www.google.com/maps/dir/?api=1&destination=${location.latitude},${location.longitude}`}
                  target="_blank"
                >
                  Get directions
                </Link>
                <br />
                <br />
                <button onClick={() => handleShowStreetView(location)}>
                  Click me repeatedly to show all pictures nearby the area!
                </button>
                <br />
                <br />
                {streetViewImageUrl && (
        ...
        <Marker
          position={[Number(userLatitude), Number(userLongitude)]}
          icon={greenIcon}
        >
          <Popup>
            <div>
